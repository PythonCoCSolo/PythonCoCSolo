...
##            return _Modern[roll] 
    ...
    def get_character_sheet(self, ListSkills = True):
        ...
        result += ('{0}\n'.format(self.get_stat_format('Sanity Points',self.SANITY_POINT)))
    ...
    def print_character(self, Hint = False, ListSkills = False):
...
#        print('{0}'.format(self.get_stat_format('Income',self.INCOME)))
#        print('{0}'.format(self.get_stat_format('Minimum Age',self.MIN_AGE)))
